...
const iconBoxClasses = computed(() => [
  "gap-8 bg-white p-8 rounded-xl shadow-md w-full max-w-full overflow-hidden",
  props.styling === "horizontal" ? "flex flex-col lg:flex-row" : "flex flex-col text-center items-center",
]);
</script>