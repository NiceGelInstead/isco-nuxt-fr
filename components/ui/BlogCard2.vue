<template>
   ...
   <div class="shadow-md rounded-t-xl md:rounded-l-xl grid grid-cols-1 md:grid-cols-2 items-stretch gap-0 md:gap-0">
  <!-- Kontainer gambar dengan responsif aspect ratio -->
  <div class="relative w-full rounded-t-xl md:rounded-l-xl aspect-video overflow-hidden">
    <img
      :src="imageSrc"
      alt="gambar-blog"
