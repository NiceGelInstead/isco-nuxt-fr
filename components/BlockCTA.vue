<template>
  <div class="container">
    <div class="flex flex-col md:flex-row justify-between items-center">
      <div>
        <div class="mb-8">
          <h2 class="isco-h3 text-white isco-text-center-left mb-4">
            Siap Untuk Bertumbuh Secara Digital?
          </h2>
          <h3 class="isco-p-desc font-medium text-white isco-text-center-left">
            Kami di sini untuk membantu. Kirim pesan untuk memulai berdiskusi!
          </h3>
        </div>
        <div
        ...
        >
          ...
          <div class="flex items-center gap-3">
            ...
            <p class="footer-p">Hasil Cepat</p>
          </div>
          <div class="flex items-center gap-3">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <p class="footer-p">5+ tahun berpengalaman</p>
          </div>
        </div>
      </div>
      <div>
