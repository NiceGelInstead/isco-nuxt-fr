      ...
      <div>
        ...
        >
          <div class="flex items-center gap-3">
            ...
            <p class="isco-paragraph text-white">5+ tahun berpengalaman</p>
          </div>
          <div class="flex items-center gap-3">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <p class="isco-paragraph text-white">Hasil Cepat</p>
          </div>
          <div class="flex items-center gap-3">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <p class="isco-paragraph text-white">Harga Terjangkau</p>
          </div>
        </div>
      </div>
      <div>
